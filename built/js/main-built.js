...
define('lazy!test2',['lazy','lazy-registry'],function(lazy) {
return lazy.getModule('test2');
});
...
define("main", ["jquery","backbone"], function(){});
...
registerModule(new lazy.Stub('test2',require,[],'01ffe443a4085ab5867fa21f9a20cd3a',null));
return {
